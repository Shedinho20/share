      ...
      <div className="flex flex-col pb-5">
        ...
        <div className="text-center mb-7">
          <button
            ...
            className={`${text === 'Created' ? activeBtnStyles : notActiveBtnStyles}`}>
            Created
          </button>
          <button
            type="button"
        ...
        {pins?.length === 0 && (
          <div className="flex justify-center font-bold items-center w-full text-1xl mt-2">No Pins Found!</div>
        )}
      </div>
    </div>
  );
