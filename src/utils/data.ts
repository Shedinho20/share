import { pinDatail } from '../components/Pindetails/Pindetails';
...
export const searchQuery = (cat: string) => {
  const query = `*[_type=="pin" && title match'${cat}*' || category match '${cat}*'  || about match '${cat}*' ]{
    image{
      asset->{
        url
      }
...
export const pinDetailMorePinQuery = (pin: pinDatail) => {
